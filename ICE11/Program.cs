...
namespace ICE11
{
        ...
        // Create a struct (a custom data type) to hold character data
    ...
    internal static class Program
    {
        ...
        public static void LoadCharacter(string path)
        {
            ...
            try
            {
                ...
                // Declare a CharacterData struct to hold the loaded data
        ...
        /// <summary>
        /// This method saves the character data as JSON to a specified file path.
        /// </summary>
        /// <param name="path"></param>
        ...
        /// <summary>
        /// This method loads character data from a JSON file at a specified path.
        /// </summary>
        /// <param name="path"></param>
        /// <returns></returns>
